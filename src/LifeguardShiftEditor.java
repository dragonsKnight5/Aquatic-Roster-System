...
public class LifeguardShiftEditor extends javax.swing.JDialog {
     ...
     */
    public LifeguardShiftEditor(main inParent, dbConnection inConnection) {
        super(inParent, true);
        initComponents();
        parent = inParent;
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                    ...
                                                    .addComponent(staffCombo2, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                    .addComponent(staffCombo3, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                                .addGap(16, 16, 16))))))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(18, 18, 18)
    ...
    private void shiftListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_shiftListValueChanged
        ...
        Date shiftDate = selectedShift.getShiftDate();
        ...
        dateString = myFormat.format(selectedDate);
        dateCombo.setSelectedItem(dateString = myFormat.format(selectedDate));
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
            ...
            == JOptionPane.YES_OPTION)
        {
            ...
            String command = "update lifeguard set shift_date= \'" + selectedDate + "\', start_time = \'" + startTime + "\', end_time = \'"
                    ...
                    + staffCombo3.getSelectedItem() + "\' where ID = \'" + ID + "\'";
